...
def migrate_lab(old_lab_path: str, new_lab_path: str):
    ...
    print()
    print("提示：修改你的代码使用 AlphaLabV2Engine:")
    print("  from vnpy.alpha.lab_v2 import AlphaLabV2Engine")
    print("  from vnpy.event import EventEngine")
    print("  from vnpy.trader.engine import MainEngine")
    print("")
    print("  event_engine = EventEngine()")
    print("  main_engine = MainEngine(event_engine)")
    print("  lab = AlphaLabV2Engine(")
    print('      main_engine=main_engine,')
    print('      event_engine=event_engine,')
    print('      root_path="./lab",')
    print('      project_name="my_strategy",')
    print('      data_source="xt",')
    print('      index_code="all_a"')
    print("  )")
